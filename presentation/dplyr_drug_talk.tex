...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   4.649    3.135
## 2 dplyr          100   1.483    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base           10  137.06    4.005
## 2 dplyr           10   34.23    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base         1000   4.382    1.547
## 2 dplyr         1000   2.832    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Changed variables:
##           old       new       
## var1      0x99c6218 0x448e6538
## 
## Changed attributes:
##           old       new       
## row.names 0xee6a0a8 0x17099d98
\end{verbatim}
\begin{alltt}
...
## Changed variables:
##           old       new       
## var1      0x892c5a0 0x1de454d0
## 
## Changed attributes:
##           old        new       
## names     0x23a7bba0 0x8868c98 
## class     0x17fffff8 0x1de05d10
## row.names 0x67f1578  0x67f1890
\end{verbatim}
\end{kframe}
\end{knitrout}
