...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   4.305    8.768
## 2 dplyr          100   0.491    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   4.659    2.988
## 2 dplyr          100   1.559    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base           10  138.48    3.953
## 2 dplyr           10   35.03    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base         1000   4.908    1.644
## 2 dplyr         1000   2.986    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Changed variables:
##           old        new      
## var1      0x10d3c660 0x94764a8
## 
## Changed attributes:
##           old        new       
## row.names 0x548836f0 0x548833d8
\end{verbatim}
\begin{alltt}
...
## Changed variables:
##           old       new       
## var1      0xb77dea8 0x1fa8d620
## 
## Changed attributes:
##           old        new       
## names     0xa70c070  0x972d510 
## class     0x1f3e35e8 0x1fa79298
## row.names 0x9cba5d8  0x9cba8f0
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{frame}[fragile]
  ...
  The following examples come from {\tt vignette("window-functions", "dplyr")}
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mu} \hlkwb{<-} \hlnum{1}\hlstd{; sigma} \hlkwb{<-} \hlnum{4}\hlstd{; N} \hlkwb{<-} \hlnum{5}\hlstd{; y} \hlkwb{<-} \hlkwd{rnorm}\hlstd{(N, mu, sigma)}
