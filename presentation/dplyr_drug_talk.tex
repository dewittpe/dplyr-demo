...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item {\tt dplyr} will save time in initial coding, debugging, code
      maintenance, \ldots
  \end{itemize}
...
## 1  base          100   95.38    4.034
## 2 dplyr          100   23.64    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   7.889    5.374
## 2 dplyr          100   1.468    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   4.568    8.957
## 2 dplyr          100   0.510    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   5.406    3.096
## 2 dplyr          100   1.746    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{frame}[allowframebreaks, fragile]
  ...
  Not implemented in {\tt dplyr\_0.2}, will be implemented in {\tt dplyr\_0.3}.
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base           10  143.78     3.96
## 2 dplyr           10   36.31     1.00
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base         1000   4.493    1.599
## 2 dplyr         1000   2.810    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Changed variables:
##           old        new      
## var1      0x2b5df708 0x6d325a0
## 
## Changed attributes:
##           old       new       
## row.names 0xc4f9af8 0x2b558c38
\end{verbatim}
\begin{alltt}
...
## Changed variables:
##           old       new      
## var1      0x93df068 0xc2b46f0
## 
## Changed attributes:
##           old       new       
## names     0x8fa0f10 0x12672460
## class     0xf93da80 0x2185d018
## row.names 0xc8fa868 0xc8fab80
\end{verbatim}
\end{kframe}
\end{knitrout}
