...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   1.958    9.505
## 2 dplyr          100   0.206    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base          100   2.174    3.345
## 2 dplyr          100   0.650    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base           10   64.55    3.389
## 2 dplyr           10   19.05    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame} 
...
\begin{verbatim}
##    test replications elapsed relative
## 1  base         1000   1.999    1.508
## 2 dplyr         1000   1.326    1.000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Changed variables:
##           old       new       
## var1      0xbbd18a0 0x338247f0
## 
## Changed attributes:
##           old        new       
## row.names 0x4f7f4b08 0x4f7f4e20
\end{verbatim}
\begin{alltt}
...
## Changed variables:
##           old        new      
## var1      0x125a59d0 0x83ae7e0
## 
## Changed attributes:
##           old        new       
## names     0x24b6ce78 0x24b73b80
## class     0xf87ef90  0x839aab8 
## row.names 0xe9e57e0  0xe9ccda0
\end{verbatim}
\end{kframe}
\end{knitrout}
